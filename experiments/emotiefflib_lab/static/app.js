...
async function checkService() {
  try {
    ...
    serviceStatus.textContent = modelData.available ? "服务就绪" : "服务就绪，等待 EmotiEffLib 依赖";
    fields.modelName.textContent = modelData.defaultModel || "-";
  } catch (error) {
...
function renderResult(payload) {
  ...
  fields.modelName.textContent = payload.features?.model || "-";
